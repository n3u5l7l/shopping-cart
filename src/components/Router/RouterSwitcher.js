      ...
      setShoppingCart((prevCart) => {
        return {
          ...
          [nutType]: {
            ...
            total: Number(event.target.value) * Number(prevCart[nutType].cost),
          },
          totalCost:
            prevCart["totalCost"] -
            prevCart[nutType].total +
            Number(event.target.value) * Number(prevCart[nutType].cost),
          totalItem:
            prevCart["totalItem"] -
            prevCart[nutType].amount +
